...
export const generatedBlueprintData = {
  chatqna: {
    ...
    demo_assets: {
      notebook:
        'https://github.com/inference-hub/blueprints/chatqna-demo.ipynb',
    ...
    blueprint_card: {
      overview:
        'ChatQnA is a Retrieval Augmented Generation (RAG) based chatbot that combines large language models with external knowledge bases to provide accurate, context-aware responses.',
      intended_use: [
      ...
      architecture:
        'RAG pipeline with vector database, embedding model, and LLM for generation',
      evaluation: [
