        ...
        <div className='space-y-8'>
          ...
          <div className='bg-gray-800 rounded-lg p-6 border border-gray-700'>
            ...
            <p className='text-gray-300 mb-6'>
              This demo showcases a comprehensive UI for managing deployment
              guide content. The editor allows you to modify sections, add new
              content, and preview changes in real-time before saving to the
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6'>
              <div className='bg-blue-600/10 border border-blue-500/20 rounded-lg p-4'>
                ...
                <p className='text-sm text-gray-300'>
                  Intuitive interface for editing deployment guide content
              ...
              <div className='bg-green-600/10 border border-green-500/20 rounded-lg p-4'>
                ...
                <p className='text-sm text-gray-300'>
                  Switch between edit and preview modes to see how your changes
                  will look.
                </p>
              </div>
              <div className='bg-purple-600/10 border border-purple-500/20 rounded-lg p-4'>
                ...
                <p className='text-sm text-gray-300'>
                  Built-in validation ensures content structure remains
            ...
            {isDeploymentGuideEditorEnabled() ? (
              ...
              <div className='bg-yellow-600/10 border border-yellow-500/20 rounded-lg p-4'>
                ...
                <p className='text-sm text-gray-300'>
                  The deployment guide content editor is only available in
                  development builds for security reasons. In production builds,
                  content should be managed through the JSON configuration files
                  directly.
                </p>
              </div>
            )}
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <div>
                ...
                <ul className='space-y-2 text-sm text-gray-300'>
                  ...
                  <li>
                    • {'{{modelSize}}'} and {'{{modelRequirements}}'}
                  </li>
            ...
            <div className='space-y-4 text-sm text-gray-300'>
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p>
                    Click the "Open Content Editor" button above to launch the
                    editing interface.
                  </p>
                </div>
              </div>
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p>
                    Use the sidebar to select categories, tabs, and sections you
                    want to edit.
                  </p>
                </div>
              </div>
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p>
                    Click on sections to expand them and modify titles,
              ...
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p>
                    Switch to preview mode to see how your changes will appear
                    to users.
                  </p>
                </div>
              </div>
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p>
                    Click "Save" to store your changes to the JSON configuration
                    file.
                  </p>
                </div>
              </div>
      ...
      {isDeploymentGuideEditorEnabled() && (
        <DeploymentGuideEditor
          ...
          onSave={content => {
            ...
            alert(
              'Content saved successfully! Check the browser console for details.'
            );
          }}
        />
      )}
