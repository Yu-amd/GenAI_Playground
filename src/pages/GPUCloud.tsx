...
const amdDeveloperCloud = {
  ...
  description:
    'Enables developers to remotely access the latest AMD Instinct™ accelerators and ROCm™ software. Get access to AMD Instinct™ MI300 accelerators in a pre-configured environment.',
...
const publicClouds = [
  ...
  },
  {
    ...
    description:
      'Offers virtual machines featuring AMD Instinct MI200-series GPUs for HPC and AI applications.',
    link: 'https://azure.microsoft.com/en-us/blog/new-azure-virtual-machines-for-hpc-and-ai-now-available/',
  },
  {
    name: 'IBM Cloud',
    description:
      'Provides access to the latest generation of AMD EPYC™ processors, suitable for various HPC workloads.',
        ...
        <div className='w-full max-w-[1200px] mx-auto py-12 px-8 flex-1'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-300'>
              Explore cloud options for accessing AMD Instinct™ series GPUs for
