...
const cloudDeployments = {
  'amd-developer-cloud': {
    ...
    description:
      'Gain hands-on experience with a variety of workloads on the ROCm software stack using AMD Developer Cloud at highly competitive pricing. Deploy your AI models on AMD Instinct™ MI300X accelerators with pre-configured ROCm environment.',
    features: [
    ...
    handsOnExperience: {
      ...
      description:
        'Get practical experience with the ROCm software stack on AMD Instinct™ MI300X accelerators.',
      benefits: [
  ...
  vultr: {
    name: 'Vultr',
    description:
      "Deploy on Vultr's AMD Instinct™ MI325X and MI300X instances with global data center coverage.",
    features: [
  ...
  'oracle-cloud-infrastructure': {
    ...
    description:
      "Deploy on Oracle's bare metal AMD Instinct™ MI300X instances for enterprise workloads.",
    features: [
  ...
  'microsoft-azure': {
    ...
    description:
      "Deploy on Azure's AMD Instinct MI210-series virtual machines for HPC and AI workloads.",
    features: [
  ...
  'hot-aisle': {
    name: 'Hot Aisle',
    description:
      "Deploy on Hot Aisle's bare metal AMD MI300X enterprise accelerators with on-demand access.",
    features: [
  ...
  tensorwave: {
    name: 'TensorWave',
    description:
      "Deploy on TensorWave's next-generation AMD accelerators with memory-optimized infrastructure.",
    features: [
...
const amdTutorialVideos = [
  {
    ...
    description:
      'Learn how to set up your first AMD Instinct instance and run your first ROCm workload.',
    thumbnail:
      'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMzIwIiBoZWlnaHQ9IjE4MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjMzc0MTUxIi8+PC9zdmc+',
  ...
  },
  {
    ...
    description:
      'Optimize your PyTorch training workflows for maximum performance on AMD Instinct MI300X.',
    thumbnail:
      'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMzIwIiBoZWlnaHQ9IjE4MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjMzc0MTUxIi8+PC9zdmc+',
  ...
  },
  {
    ...
    description:
      'Complete guide to deploying TensorFlow models on AMD Developer Cloud with ROCm.',
    thumbnail:
      'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMzIwIiBoZWlnaHQ9IjE4MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjMzc0MTUxIi8+PC9zdmc+',
  ...
  },
  {
    ...
    description:
      'Scale your LLM training to multiple MI300X instances with distributed training.',
    thumbnail:
      'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMzIwIiBoZWlnaHQ9IjE4MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjMzc0MTUxIi8+PC9zdmc+',
  ...
  },
  {
    ...
    description:
      'Build and deploy computer vision models using AMD Instinct accelerators.',
    thumbnail:
      'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMzIwIiBoZWlnaHQ9IjE4MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjMzc0MTUxIi8+PC9zdmc+',
  ...
  },
  {
    ...
    description:
      'Advanced techniques for optimizing performance on AMD Instinct GPU instances.',
    thumbnail:
      'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMzIwIiBoZWlnaHQ9IjE4MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjMzc0MTUxIi8+PC9zdmc+',
...
const CloudDeployment: React.FC = () => {
  ...
  const [gettingStartedTab, setGettingStartedTab] = useState<
    'setup' | 'tutorials'
  >('setup');

  const cloudConfig =
    cloudDeployments[cloudId as keyof typeof cloudDeployments];
                  ...
                  <div className='p-8'>
                    {gettingStartedTab === 'setup' && (
                      <div>
                        ...
                        <p className='text-sm text-gray-400 mb-6'>
                          Configure your AMD Developer Cloud account
                        </p>
                        ...
                        <div className='mb-6'>
                          ...
                          <div className='space-y-3 text-sm text-gray-300'>
                            <div className='flex items-start'>
                              <div className='w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-0.5 text-xs font-bold text-white'>
                                1
                              </div>
                              <div>
                                <span className='font-medium text-white'>
                                  Create AMD Developer Cloud account
                                </span>
                                <p className='text-gray-400 mt-1'>
                                  Sign up at developer.amd.com and verify your
                                  email address
                                </p>
                              </div>
                            </div>
                            <div className='flex items-start'>
                              ...
                              <div>
                                ...
                                <p className='text-gray-400 mt-1'>
                                  Generate SSH keys and add them to your AMD
                            ...
                            <div className='flex items-start'>
                              ...
                              <div>
                                ...
                                <p className='text-gray-400 mt-1'>
                                  Set up payment method and review instance
                            ...
                            <div className='flex items-start'>
                              ...
                              <div>
                                ...
                                <p className='text-gray-400 mt-1'>
                                  Review ROCm documentation and compatibility
                                  guides for your workloads
                                </p>
                              </div>
                            </div>
                          </div>
                    ...
                    {gettingStartedTab === 'tutorials' && (
                      <div>
                        ...
                        <p className='text-sm text-gray-400 mb-6'>
                          Step-by-step video guides for AI workloads
                        </p>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                          {amdTutorialVideos.slice(0, 6).map((video, idx) => (
                            <div
                              key={idx}
                              className='bg-gray-900/60 rounded-lg p-3 border border-gray-700 flex flex-col'
                            >
                              ...
                              <a
                                ...
                                className='mt-auto inline-block bg-purple-600 hover:bg-purple-700 text-white px-3 py-2 rounded text-xs font-medium text-center'
                              >
                                Watch Video
                              </a>
                            </div>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
              ...
              <div className='lg:col-span-2'>
                <div className='bg-white/5 backdrop-blur-md border border-white/20 rounded-2xl p-8'>
                  <h3 className='text-xl font-bold text-white mb-4'>
                    Getting Started with {cloudConfig.name}
                  </h3>
                  <p className='text-sm text-gray-400 mb-6'>
                    Learn how to deploy and run workloads on {cloudConfig.name}
                  </p>
                        ...
                        <div className='mb-4'>
                          <div className='bg-black/30 rounded-lg p-4 border border-white/10'>
                            ...
                            <p className='text-xs text-gray-400 mt-2'>
                              Complete walkthrough of {step.title.toLowerCase()}{' '}
                              on {cloudConfig.name}
                            </p>
                          </div>
                        </div>
