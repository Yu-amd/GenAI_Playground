...
const LandingPage: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Pre-built GenAI applications tested and optimized for AMD Instinct™ GPUs'
    },
    {
      icon: FaCloud,
      title: 'Seamless Cloud Access',
      description: 'Easy deployment on AMD Instinct™ GPUs across multiple cloud providers'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-white font-sans">
      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <div className="text-center max-w-4xl mx-auto px-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                Explore Models <div className="group-hover:translate-x-1 transition-transform"><FaArrowRight /></div>
              </Link>
              <Link
                to="/blueprints"
        ...
        <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-10">
          <div className="flex flex-col items-center text-white/40 hover:text-white/60 transition-colors duration-500 cursor-pointer group">
            ...
            >
              <path d="M3 6l9 5 9-5M3 13l9 5 9-5" className="opacity-30 group-hover:opacity-50 transition-opacity duration-500" />
            </svg>
          </div>
        </div>
      </div>
      ...
      <div className="py-20 bg-gradient-to-r from-neutral-800/50 to-neutral-900/50">
        <div className="max-w-6xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">Optimized language models running on AMD Instinct™ GPUs</p>
          </div>
          ...
          <div className="text-center mt-12">
            ...
            >
              View All Models <div className="group-hover:translate-x-1 transition-transform"><FaArrowRight /></div>
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="py-20">
        <div className="max-w-6xl mx-auto px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Ready-to-Use AI Blueprints</h2>
            <p className="text-xl text-gray-300">Pre-built GenAI applications optimized for AMD Instinct™ GPUs</p>
          </div>
      ...
      <div className="py-20 bg-gradient-to-r from-neutral-800/50 to-neutral-900/50">
        <div className="max-w-6xl mx-auto px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">AMD Instinct™ GPU Cloud Access</h2>
            <p className="text-xl text-gray-300">High-performance AMD Instinct™ accelerators for your GenAI workloads</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-8">
              ...
              <p className="text-gray-300 mb-6">
                Access the latest AMD Instinct™ accelerators and ROCm™ software in a pre-configured environment.
              </p>
              <Link
                to="/gpu-cloud"
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">Public Cloud Providers</h3>
              <p className="text-gray-300 mb-6">
                Access AMD Instinct™ GPUs through leading cloud providers including Vultr, Azure, Oracle, and more.
              </p>
              <Link
                to="/gpu-cloud"
      ...
      <div className="py-20 bg-gradient-to-r from-blue-900/30 to-purple-900/30 border-t border-white/10">
        <div className="max-w-4xl mx-auto px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">Ready for Enterprise Deployment?</h2>
