    ...
    this.knowledgeBase = [
      {
        ...
        content:
          'ChatQnA is a powerful chatbot application based on Retrieval Augmented Generation (RAG) architecture. It combines the power of large language models with efficient information retrieval from knowledge bases to provide accurate and context-aware responses.',
      ...
      },
      {
        ...
        content:
          'Retrieval Augmented Generation (RAG) works by first retrieving relevant documents from a knowledge base using semantic search, then using those documents as context for the language model to generate accurate responses.',
      ...
      },
      {
        ...
        content:
          'Vector databases like Pinecone, Weaviate, and Qdrant are essential for RAG systems as they enable efficient similarity search over document embeddings. They store high-dimensional vectors and provide fast retrieval capabilities.',
      ...
      },
      {
        ...
        content:
          "Embedding models convert text into numerical vectors that capture semantic meaning. Popular models include OpenAI's text-embedding-ada-002, Sentence Transformers, and Cohere embeddings. These enable semantic similarity search.",
        url: 'https://example.com/embedding-models',
        metadata: {
          category: 'models',
          tags: ['embeddings', 'semantic-search', 'AI-models'],
        },
      },
      {
        id: '5',
        ...
        content:
          'Effective context management is crucial for maintaining coherent conversations. This involves managing conversation history, session state, and context windowing to ensure the chatbot remembers previous interactions.',
        url: 'https://example.com/context-management',
        metadata: {
          category: 'chatbot',
          tags: ['context', 'conversation', 'session-management'],
        },
      },
    ];
  }
...
Please provide a helpful response to the user's query.`;
  ...
  async addDocument(
    document: Omit<KnowledgeBaseDocument, 'id'>
  ): Promise<string> {
  ...
  getKnowledgeBaseStats() {
    return {
      ...
      categories: this.knowledgeBase.reduce(
        (acc, doc) => {
