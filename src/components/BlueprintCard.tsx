...
const BlueprintCard: React.FC<BlueprintCardProps> = ({
  ...
  >
    ...
    <div className="flex-1 min-w-0 flex flex-col justify-center">
      <span className="text-xs uppercase tracking-widest text-blue-200 font-semibold mb-1">{label}</span>
      <h2 className="text-xl font-bold mb-2 group-hover:text-blue-400 transition truncate">{name}</h2>
      <div className="text-base text-neutral-200 mb-4 line-clamp-2">{description}</div>
    </div>
  </div>
);
