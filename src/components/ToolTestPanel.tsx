        ...
        <div className='mb-6 p-4 bg-white/5 rounded-lg border border-white/10'>
          ...
          <div className='grid grid-cols-2 gap-4 text-sm'>
            <div className='flex items-center gap-2'>
              <div
                className={`w-3 h-3 rounded-full ${isToolCallingEnabled ? 'bg-green-500' : 'bg-red-500'}`}
              ></div>
              <span className='text-gray-300'>Tool Calling:</span>
              <span
                className={
                  isToolCallingEnabled ? 'text-green-400' : 'text-red-400'
                }
              >
            ...
            <div className='flex items-center gap-2'>
              <div
                className={`w-3 h-3 rounded-full ${enabledTools.length > 0 ? 'bg-green-500' : 'bg-red-500'}`}
              ></div>
