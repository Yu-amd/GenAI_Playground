...
const ToolSelector: React.FC<ToolSelectorProps> = ({
  ...
  return (
    ...
    >
      <div
        className='relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl w-full max-w-2xl mx-auto p-8 overflow-y-auto max-h-[80vh]'
      ...
      >
        ...
        <p className='text-gray-300 mb-6'>
          Select which tools you want to enable for this conversation. Enabled
          tools will be available for the AI to use when responding to your
          messages.
        </p>
